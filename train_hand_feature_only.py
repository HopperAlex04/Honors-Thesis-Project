...
for x in range(start_round, rounds):
    ...
    try:
        Training.selfPlayTraining(trainee, trainee, eps_per_round, model_id=f"hand_only_round_{x}_selfplay")
    except Exception as e:
    ...
    try:
        p1w, p2w = Training.selfPlayTraining(trainee, valid_agent, eps_per_round, True, model_id=f"hand_only_round_{x}_vs_previous")
    except Exception as e:
    ...
    try:
        p1w, p2w = Training.selfPlayTraining(trainee, validation00, eps_per_round, True, model_id=f"hand_only_round_{x}_vs_randomized")
    ...
    try:
        p1w, p2w = Training.selfPlayTraining(trainee, validation01, eps_per_round, True, model_id=f"hand_only_round_{x}_vs_heuristic")
    ...
    try:
        p1w, p2w = Training.selfPlayTraining(trainee, validation02, eps_per_round, True, model_id=f"hand_only_round_{x}_vs_gapmaximizer")
